    ...
    const byLevel: Record<LearningLevel, Candidate[]> = {
      1: [
        this.activity({
          ...
          kind: "match",
          adventureKind: "seek",
          title: `Coach: explore the ${name}`,
          prompt: `Ask your child if they can find something special on the ${name}.`,
          rationale: "Level 1 parent coaching — connection, not quizzes",
          reasonCodes: ["level_1_parent_coach", "naming"],
        }),
        this.activity({
          ...base,
          kind: "sound",
          adventureKind: "sound",
          title: `Coach: listen for ${name}`,
          prompt: `Can they hear or make the sound of the ${name} with you?`,
          rationale: "Level 1 parent coaching — sounds together",
          reasonCodes: ["level_1_parent_coach", "sound"],
        }),
      ],
      2: [
        this.activity({
